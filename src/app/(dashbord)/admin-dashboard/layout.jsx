...
import { FiHome, FiUsers, FiBook, FiDollarSign, FiSettings, FiMenu, FiX, FiArrowLeft } from 'react-icons/fi';
...
const AdminLayout = ({ children }) => {
    ...
    const navItems = [
        ...
        { name: 'Manage Courses', href: '/admin-dashboard/manageCourse', icon: <FiBook /> },
        { name: 'Payments', href: '/admin-dashboard/payments', icon: <FiDollarSign /> },
    ];
        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="container mx-auto flex">
                ...
                <aside className="hidden md:block w-64 bg-white border-r border-gray-200 shadow-md p-5 fixed h-screen">
                    <h2 className="text-2xl font-extrabold text-blue-600 mb-8">Admin Panel</h2>

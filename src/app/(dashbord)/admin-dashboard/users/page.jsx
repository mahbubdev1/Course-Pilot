...
const ManageUser = () => {
    ...
    const handleRoleChange = (id, newRole) => {
        axiosPublic.patch(`/manageUsers/${id}`, { role: newRole })
            .then(res => {
    ...
    const handleRemove = id => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axiosPublic.delete(`/manageUsers/${id}`)
                    .then(res => {
    ...
    return (
        <div className="p-2 sm:p-4">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Manage Users</h2>
